    ...
    <div class="container-fluid py-5">
      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
        ...
        <div class="col mb-4">
          <div class="card bg-light text-center border-light shadow h-100">
            <div class="card-body">
              ...
              <hr class="bg-primary" />
              <p class="card-text">A simple to-do list built in React, where tasks can be added and deleted when completed.
              </p>
            </div>
            <div class="card-footer">
        ...
        <div class="col mb-4">
          <div class="card bg-light text-center border-light shadow h-100">
            <div class="card-body">
              <h3 class="card-title">Spinning Wheel Random Picker</h3>
              <hr class="bg-primary" />
              <p class="card-text">A simple spinning wheel picker app built using React and the styled-components library.</p>
            </div>
            <div class="card-footer">
              <a class="btn btn-outline-primary btn-lg mt-2" role="button" href="https://wheel-picker-nine.vercel.app/" target="_blank">Spinning Wheel Random Picker</a>
            </div>
          </div>
        </div>
        <!-- Portfolio Item End -->
        ...
        <div class="col mb-4">
          <div class="card bg-light text-center border-light shadow h-100">
            <div class="card-body">
              <h3 class="card-title">Drag and Drop Canvas Demo</h3>
              <hr class="bg-primary" />
              <p class="card-text">A demonstration of dragging and dropping elements on a canvas with added panning and zooming functionalities built using React and Typescript. </p>
            </div>
            <div class="card-footer">
              <a class="btn btn-outline-primary btn-lg mt-2" role="button" href="https://figma-miro-canvas.vercel.app/" target="_blank">Drag And Drop Canvas Demo</a>
            </div>
          </div>
        </div>
        <!-- Portfolio Item End -->
        ...
        <div class="col mb-4">
          <div class="card bg-light text-center border-light shadow h-100">
            <div class="card-body">
              <h3 class="card-title">Simple Code Explainer</h3>
              <hr class="bg-primary" />
              <p class="card-text">A simple Code Explainer for JavaScript, Python, and Java built using React 19 and using the "gpt-oss-120b" LLM.</p>
            </div>
            <div class="card-footer">
              <a class="btn btn-outline-primary btn-lg mt-2" role="button" href="https://ai-code-explainer-sepia.vercel.app/" target="_blank">Simple Code Explainer</a>
            </div>
          </div>
        </div>
        <!-- Portfolio Item End -->
